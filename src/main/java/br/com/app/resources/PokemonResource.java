...
public class PokemonResource {
	...
	public ResponseEntity updatePokemon(@PathVariable(name = "id") Integer id, @RequestBody Pokemon pokemon) {
		return ResponseEntity.ok().body(this.service.update(id, pokemon));
	}
	
	@DeleteMapping(value = "/pokemons/{id}")
	public ResponseEntity deletePokemon(@PathVariable(name = "id") Integer id) {
